...
export default class MultiSelect extends Component {
  static propTypes = {
    ...
    showSelectTextSingle:PropTypes.bool,
  };
  ...
  _getSelectLabel = () => {
    ...
    if (!selectedItems || selectedItems.length === 0) {
      ...
      if(showSelectTextSingle && selectedItems.length > 0){
        return selectText + ": " + get(foundItem, displayKey) || selectText;
      }

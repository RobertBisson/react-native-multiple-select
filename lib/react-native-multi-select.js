...
export default class MultiSelect extends Component {
    static propTypes = {
        ...
        showSelectTextSelected: PropTypes.bool
    };
    ...
    _getSelectLabel = () => {
        ...
        if (!selectedItems || selectedItems.length === 0) {
            ...
            return get(foundItem, displayKey) || null;
        }
                        ...
                        <View style={styles.dropdownView}>
                            ...
                            >
                                <TouchableWithoutFeedback onPress={this._toggleSelector}>
                                    ...
                                    >
                                            {(showSelectTextSelected == true || (selectedItems &&selectedItems.length == 0) )&& <View
                                                    style={[
                                                        {
                                                            flex: 2
                                                        }
                                        ...
                                        >
                                                    ...
                                                    <Text
                                                        style={[
                                                            ...
                                                            altFontFamily
                                                                ? { fontFamily: altFontFamily }
                                                                : fontFamily ? { fontFamily } : {},
                                                            showSelectTextSelected==false?{  padding: 12,
                                                                marginLeft: 10}:null
                                                        ]}
                                                        numberOfLines={1}
                                                    >
                                            ...
                                            <Icon
                                                name={
                                                    hideSubmitButton ? "expand-more" : "expand-more"
                                                }
                                                size={28}
                                                style={[
                                                    styles.indicator,
